...
🎓 Estudante de ADS — UNINTER<br>

🐍 Foco em Python, back-end e bancos de dados.<br>
⚡Linux & Open Source <br>

Estudando e explorando diferentes áreas de tecnologia. <br>
Atualmente focando em frameworks e tecnologias em Python e Linux.

🀄 Outros interesses: metal, jogos, animes, escrita, idiomas, xadrez e boardgames.
<br>
<br>
